...
class CleanupQuicksight:
    def __init__(self, region, stackName):
    ...
    def cleanup(self):
        ...
        for dataSet in myDataSets:
            if dataSet['Name'] == self.stackName:
                print('Removing DataSet: {} {}'.format(dataSet['Name'], dataSet['DataSetId']))
        ...
        for dataSource in myDataSources:
            if dataSource['Name'] == self.stackName:
                print('Removing DataSource: {} {}'.format(dataSource['Name'], dataSource['DataSourceId']))
