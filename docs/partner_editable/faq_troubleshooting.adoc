...
*A.* Documentation for developing connectors for ISV partners is found in the https://github.com/aws-quickstart/quickstart-aws-industrial-machine-connectivity/blob/main/assets/readme/unify-connector-development-guide.md[Element Unify Connector Development Guide]. A reference guide can also be found within https://app001-aws.elementanalytics.com/docs[Element Unify's Developer Portal].
