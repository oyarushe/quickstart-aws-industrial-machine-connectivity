...
[start=2]
.. *Option 2 - Element Unify* Element Unify is a data management platform to integrate, contextualize, and govern industrial IT/OT data. Element Unify automates publishes asset models to AWS IoT SiteWise.
+
Following are the benefits of Element Unify:
+
* Ingest metadata from edge devices such as Ignition and KepServerEx
* Cross-application data modeling allows modeling of multiple source systems
* Low-code, no-code transformations to easily standardize data
* Maintain evergreen AWS IoT SiteWise data models
* Automate bulk text extraction from P&Industrial
* Metadata system of record supports other AWS Applications
